 ...
 * @param {any[]} pieces - un tableau d'objets, chaque objet a un nom, un prix et une disponibilité.
 */
 ...
 * @param {Element} activeClass - La classe à laquelle vous souhaitez ajouter la classe active
 * @param {Element[]} remove - Les classes dont vous souhaitez supprimer la classe active.
 */
 ...
 * @param {string} classRemove - La classe que vous souhaitez supprimer
 * @param {Element[]} remove - Les éléments dont vous souhaitez supprimer la classe.
 */
 ...
 * afficher les avis.
 * @param {any[]} pieces - un tableau d'objets
 */
